...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <script>
            var base_url = '{{url('/')}}';
            var timeRefresh = {{ config('weather.timeRefresh', 20000) }};
        </script>
        <script src=" https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.12.2/umd/popper.min.js"></script>
        <script src="{{asset('js\jquery\dist\jquery.js')}}"></script>
        <script src="{{ asset('js/app.js') }}?ver=1544535" ></script>
        ...
        <link href="{{asset('css/app.css')}}?ver=999737" rel="stylesheet">
                        ...
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="{{ route('cities.index') }}">Miasta</a>
